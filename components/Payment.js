...
const Payment = () => {
  ...
  return (
    ...
    transition-colors duration-200 ease-in-out text-xl'>₹ Donate</button>
        {/* <!-- Main modal --> */}
<div id="crud-modal" tabindex="-1" aria-hidden="true" className={` ${toggle?"":"hidden"} overflow-y-auto overflow-x-hidden absolute top-36 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full`}>
